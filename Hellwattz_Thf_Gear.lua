...
function init_gear_sets()
	...
	sets.TreasureHunter = set_combine(sets.TreasureHunter, {ammo="Per. Lucky Egg",waist="Chaac Belt",hands="Plunderer's Armlets +1",feet="Skulk. Poulaines +1"})
    sets.ExtraRegen = {}
	...
	-- Weapons sets
	sets.weapons.Aeneas = {main="Kaja Sword",sub="Taming Sari"}
